...
namespace myapp.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Department", "EmployeeId", "FirstName", "IsDxStaff", "LastName", "Password", "Role" },
                values: new object[] { 1, "IT", "admin", "แอดมิน", false, "ระบบ", "$2a$11$LhM27vKLaaDHqW9SJo3qoeswGqWwNQKADa6Z8CYfCg5NCk8UAFiHq", "Admin" });
